     ...
     <header role="banner" class="ui-section-header">
       <div class="ui-layout-container">
         <div class="ui-section-header__layout ui-layout-flex">
           ...
           <!-- MENU -->
           <h1 class="logo__header"> Вакансии </h1>
         ...
         <div class="ui-layout-container">
           <div class="ui-section-hero__layout ui-layout-grid ui-layout-grid-2">
             ...
             <div>
               ...
               <p class="ui-text-intro">Философия пекарни-кондитерской проста — создавай и совершенствуйся. Поэтому в команду мы ищем страстных и трудолюбивых людей. Хлеб, десерты и выпечка создаются вручную, поэтому выбору и подготовке мастеров уделяется большое внимание. Наша пекарня предлагает конкурентоспособную оплату труда, возможности учиться и расти. Выбирайте подходящую вакансию и звоните нам. Возможно, мы ждем именно вас!</p>
                <h2>Наши контакты</h2>
                <p class="ui-text-intro">+375291347173<br>
                    +375445820370</p>
             ...
             <!-- IMAGE -->
             <img src="images/girl.jpg" loading="lazy" alt="#" class="ui-image-half-left">
           </div>
         </div>
       </section>
